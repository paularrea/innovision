    ...
    <>
      <FadeInOnScroll>
        <div className="row about-photos-text-container">
          <div className="col-12 col-md-6 about-photos about1 w-50"></div>
        ...
        <div className="about-separators"></div>
        ...
        <div className="row about-photos-text-container">
          ...
          <div className="col-12 col-md-6 about-photos about2 w-50"></div>
        </div>

        <div className="about-separators"></div>

        <div className="row about-photos-text-container">
          <div className="col-12 col-md-6 about-photos about3 w-50"></div>
          <div className="col-12 col-md-6">
            <div className="about-text-wrapper-left">
